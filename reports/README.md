...
3. Заполните обязательные поля отчета:
   ...
   - **Фотографии** - визуальная фиксация этапов выполнения
...
![Кнопка создания отчета в списке](../images/create_bnt_report1.jpg)

**Кнопка создания отчета в меню:**
![Кнопка создания отчета в меню](../images/create_bnt_report2.jpg)

**Форма создания отчета:**
![Форма создания отчета](../images/create_report.jpg)
